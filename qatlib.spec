...
Version  : 23.08.0
Release  : 6
URL      : https://github.com/intel/qatlib/archive/23.08.0/qatlib-23.08.0.tar.gz
Source0  : https://github.com/intel/qatlib/archive/23.08.0/qatlib-23.08.0.tar.gz
...
%prep
%setup -q -n qatlib-23.08.0
cd %{_builddir}/qatlib-23.08.0
pushd ..
cp -a qatlib-23.08.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1694041277
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libqat.so.4.0.0
/V3/usr/lib64/libusdm.so.0.1.0
/usr/lib64/libqat.so.4
/usr/lib64/libqat.so.4.0.0
