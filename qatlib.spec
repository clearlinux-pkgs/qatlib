...
Version  : 23.11.0
Release  : 7
URL      : https://github.com/intel/qatlib/archive/23.11.0/qatlib-23.11.0.tar.gz
Source0  : https://github.com/intel/qatlib/archive/23.11.0/qatlib-23.11.0.tar.gz
...
%prep
%setup -q -n qatlib-23.11.0
cd %{_builddir}/qatlib-23.11.0
pushd ..
cp -a qatlib-23.11.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1700155452
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libqat.so.4.1.0
/V3/usr/lib64/libusdm.so.0.1.0
/usr/lib64/libqat.so.4
/usr/lib64/libqat.so.4.1.0
