...
Version  : 24.02.0
Release  : 9
URL      : https://github.com/intel/qatlib/archive/24.02.0/qatlib-24.02.0.tar.gz
Source0  : https://github.com/intel/qatlib/archive/24.02.0/qatlib-24.02.0.tar.gz
...
%prep
%setup -q -n qatlib-24.02.0
cd %{_builddir}/qatlib-24.02.0
pushd ..
cp -a qatlib-24.02.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708461861
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libqat.so.4.2.0
/V3/usr/lib64/libusdm.so.0.1.0
/usr/lib64/libqat.so.4
/usr/lib64/libqat.so.4.2.0
