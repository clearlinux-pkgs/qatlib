...
Version  : 22.07.1
Release  : 3
URL      : https://github.com/intel/qatlib/archive/22.07.1/qatlib-22.07.1.tar.gz
Source0  : https://github.com/intel/qatlib/archive/22.07.1/qatlib-22.07.1.tar.gz
...
%prep
%setup -q -n qatlib-22.07.1
cd %{_builddir}/qatlib-22.07.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666281143
